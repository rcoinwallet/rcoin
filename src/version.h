...
// Copyright (c) 2012-2013 The RCoin developers
...
#define RCoin_VERSION_MAJOR       1
#define RCoin_VERSION_MINOR       0
#define RCoin_VERSION_REVISION    0
#define RCoin_VERSION_BUILD       0

static const int RCoin_VERSION =
                           1000000 * RCoin_VERSION_MAJOR
                         +   10000 * RCoin_VERSION_MINOR
                         +     100 * RCoin_VERSION_REVISION
                         +       1 * RCoin_VERSION_BUILD;

// RCoin version - reference for code tracking

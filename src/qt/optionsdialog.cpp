        ...
        QWidget(parent)
{
    ...
    bitcoin_at_startup = new QCheckBox(tr("&Start RCoin on window system startup"));
    bitcoin_at_startup->setToolTip(tr("Automatically start RCoin after the computer is turned on"));

...
{
    resize(850, 550);
    setWindowTitle(tr("RCoin Wallet"));
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/RCoin_icon"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/RCoin_tooltip"), tr("&About RCoin"), this);
    ...
    toggleHideAction = new QAction(QIcon(":/icons/RCoin_tooltip"), tr("Show/Hide &RCoin"), this);
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        if(clientModel->isTestNet())
        {
            ...
            setWindowIcon(QIcon(":icons/RCoin_icon"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/RCoin_icon"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(title_testnet);
                trayIcon->setIcon(QIcon(":/icons/RCoin_tooltip"));
            }
        }

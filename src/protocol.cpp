...
// RCoin message start (switch from Bitcoin's in v0.2)
static unsigned char pchMessageStartBitcoin[4] = { 0x1a, 0x1b, 0x1c, 0x1d };
static unsigned char pchMessageStartRCoin[4] = { 0xb3, 0xc3, 0xd3, 0xa3 };
...
void GetMessageStart(unsigned char pchMessageStart[], bool fPersistent)
{
    if (fTestNet)
        ...
        memcpy(pchMessageStart, (fPersistent || GetAdjustedTime() > nMessageStartSwitchTime)? pchMessageStartRCoin : pchMessageStartBitcoin, sizeof(pchMessageStartRCoin));
}
